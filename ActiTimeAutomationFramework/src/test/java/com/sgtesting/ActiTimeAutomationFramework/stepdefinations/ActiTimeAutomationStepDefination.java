package com.sgtesting.ActiTimeAutomationFramework.stepdefinations;
...
import com.sgtesting.ActiTimeAutomationFramework.stepdefinations.ActiTimeAutomationPages;
import com.sgtesting.ActiTimeAutomationFramework.utility.ApplicationDependent;
import com.sgtesting.ActiTimeAutomationFramework.utility.ApplicationIndependent;
...
public class ActiTimeAutomationStepDefination {
	
	public static WebDriver oBrowser=null;
	public static String firstname=null;
	public static String lastname=null;
	public static ActiTimeAutomationPages actiTimeAtomationPage=null;
	public static Logger log=LogManager.getLogger(ActiTimeAutomationStepDefination.class);
	...
	public void Launch_the_application()
	{
		try
		{
			...
			actiTimeAtomationPage=new ActiTimeAutomationPages(oBrowser);
	...
	{  
		try
		{
			...
			{
				actiTimeAtomationPage.getUserName().sendKeys(data.get(i).get("username"));
				actiTimeAtomationPage.getPassword().sendKeys(data.get(i).get("password"));
				actiTimeAtomationPage.getLoginBtn().click();
				ApplicationIndependent.waitFor(5L);
			}
	...
	public void Perform_logout_action()
	{
		try
		{
			...
			actiTimeAtomationPage.getLogoutLink().click();
			ApplicationIndependent.waitFor(2L);
	...
	{  
		try
		{
			actiTimeAtomationPage.getUserName().sendKeys(username);
			actiTimeAtomationPage.getPassword().sendKeys(password);
			actiTimeAtomationPage.getLoginBtn().click();
